...
/**
 * 类描述：  一个方便在多种状态切换的view（加载中、空视图、加载错误等）
 * 创建人:   续写经典
 * 创建时间: 2016/1/15 10:20.
 */
public class GSDefaultLoadingView extends RelativeLayout {
    ...
    public GSDefaultLoadingView(Context context) {
        this(context, null);
    }

    public GSDefaultLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GSDefaultLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        emptyViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.gs_comm_defaule_empty_view);
        errorViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.gs_comm_defaule_error_view);
        loadingViewResId =
                a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.gs_comm_defaule_loading);
...
//                R.layout.layout_no_network_view);
    ...
    public boolean isLoading() {
        return viewStatus == STATUS_LOADING;
    }
